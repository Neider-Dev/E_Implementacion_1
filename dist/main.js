...
function mostrarDirector(nombre) {
...
function mostrarPlataforma(nombre) {
...
let listadoCategorias = ["Romance", "Comedia", "Drama", "Suspenso", "Acción", "Animación", "Terror"];
